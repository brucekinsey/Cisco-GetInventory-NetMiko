...
def main():
    ...
    print("(4b) Autodetecting device types (concurrent)")
    print_current_time()
    autodetect_devices(network_devices, setup_vars["settings"]["max_threads"])

    # Now finalize/validate after autodetect has populated parse_method
...
####Save Functions
def save_device_data(net_devices, wb_obj, setup_vars, key_map, input_file_name):
